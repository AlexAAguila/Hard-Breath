...
public class ChangeScene : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)//This was placed in the dark room on the back wall
        //Once the player goes to the back of the room it changes the scene
    {
